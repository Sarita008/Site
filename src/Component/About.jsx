     ...
     <>
       <div className='content'>
          <div className='Heading'>
             <h1>About Us</h1>
             <p className='para'>Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis <br />aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.<br /> Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit <br />anim id est laborum.</p>
          </div>

          <div className='img'>
            <img src='https://avon-demo.myshopify.com/cdn/shop/files/fashion_787be7e7-7c09-4366-b4a8-226812bed4ea.jpg?v=1614330596'  />
          </div>
                ...
                <div className='about'>
                    ...
                    <div className='image'>
                        <div className='image_main'>
                            <img src='https://avon-demo.myshopify.com/cdn/shop/files/demo2-about-3_400x.jpg?v=1614330612'  />
                            <h4>ANGELA ROBOT</h4>
                            <p>FOUNDER & CEO</p>
                        </div>
                        <div className='image_main'>
                            <img src='https://avon-demo.myshopify.com/cdn/shop/files/demo2-about-2_400x.jpg?v=1614330612'  />
                            <h4>JULIA WILLE</h4>
                            <p>Co. FOUNDER</p>
                        </div>
                        <div className='image_main'>
                            <img src='https://avon-demo.myshopify.com/cdn/shop/files/demo2-about-1_400x.jpg?v=1614330612' />
                            <h4>STEVE SMITH</h4>
